...
def DFS(state: Board) -> Board:
    ...
    while not board_stack.is_empty():
        ...
        cellcoords = board.find_most_constrained_cell()
        cellrow, cellcol = cellcoords

        for val in board.rows[cellrow][cellcol]:
            new_board: Board = copy.deepcopy(board)
            new_board.update(cellrow, cellcol, val)
...
if __name__ == "__main__":
    ...
    print("DFS and BFS tests passed!")
    pass